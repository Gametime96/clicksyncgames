...
@media (max-width: 800px) and (orientation: portrait) {
    ...
    .top-left, .top-right { top: 40px !important; } /* Push HUD down slightly */
}
...
.bottom-center { bottom: 20px; left: 50%; transform: translateX(-50%); width: 80%; text-align: center; max-width: 400px; }
...
.bar-bg { width: clamp(100px, 20vw, 180px); height: 10px; background: #0a1120; border: 1px solid #2a3b5c; border-radius: 6px; overflow: hidden; margin-top: 8px; }
.w-full { width: 100%; }
...
@media (max-width: 480px) {
    .dpad-grid { grid-template-columns: 50px 50px 50px; grid-template-rows: 50px 50px 50px; }
    .bottom-center { bottom: 10px; }
    #touch-pad { bottom: 10px; right: 10px; }
